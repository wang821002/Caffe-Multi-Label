...
const char* UpgradeV1LayerType(const V1LayerParameter_LayerType type) {
  ...
  case V1LayerParameter_LayerType_IMAGE_DATA:
    return "ImageData";
  case V1LayerParameter_LayerType_IMAGE_DATA_MULTI_LABEL:
    return "ImageDataMultiLabel"; // WXS
  ...
  case V1LayerParameter_LayerType_POOLING:
    return "Pooling";
  case V1LayerParameter_LayerType_LSE_POOLING:
    return "LsePooling"; //WXS
  ...
  case V1LayerParameter_LayerType_WEIGHTED_SIGMOID_CROSS_ENTROPY_LOSS:
    return "WeightedSigmoidCrossEntropyLoss"; //WXS
